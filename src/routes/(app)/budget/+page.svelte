...
<IsometricCard title="Budget Details">
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
      <PixelButton variant="secondary" onclick={goToAICoach} class="h-10 px-2 sm:px-3">
         <span class="material-symbols-outlined text-sm">smart_toy</span>
         <span class="text-[9px] sm:text-xs ml-1">AI SETUP</span>
      </PixelButton>
      <PixelButton variant="primary" onclick={openAddModal} class="h-10 px-2 sm:px-3">
         <span class="material-symbols-outlined text-sm">add</span>
         <span class="text-[9px] sm:text-xs ml-1">ADD BUDGET</span>
      </PixelButton>
    </div>
  </div>
